...
\begin{figure}
\centering
\subfigure{\includegraphics[width=.48\textwidth]{Code/Util/fisheriris.pdf}}
\subfigure{\includegraphics[width=.48\textwidth]{Code/Util/balance.pdf}}
\subfigure{\includegraphics[width=.48\textwidth]{Code/Util/parkinsons.pdf}}
\subfigure{\includegraphics[width=.48\textwidth]{Code/Util/sonar.pdf}}
%\subfigure{\includegraphics[width=.7\textwidth]{Code/Util/usps.pdf}}
